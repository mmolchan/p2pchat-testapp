...
struct rbnode *rbfind_near      __P((struct rbtree *, void *, enum rbfindmode));
...
struct rbnode *rbnodefirst      __P((struct rbtree *));
struct rbnode *rbnodenext       __P((struct rbtree *, struct rbnode *));
void rbforeach                  __P((struct rbtree *, void (*fn)(struct rbtree* tree,
                                                                 struct rbnode *, void*),
                                     void *));
